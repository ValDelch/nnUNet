...
from dynamic_network_architectures.building_blocks.simple_conv_blocks_bcnn import StackedConvBlocks, ConvDropoutNormReLU
from dynamic_network_architectures.building_blocks.helper_bcnn import get_matching_convtransp
...
class UNetDecoder(nn.Module):
    def __init__(self,
        ...
        for s in range(1, n_stages_encoder):
            ...
            transpconvs.append(
                nn.Sequential(
                    transpconv_op(scale_factor=stride_for_transpconv[0]),
                    ConvDropoutNormReLU(
                        conv_op=BesselConv2d,
...
if __name__ == '__main__':
    ...
    input_channels = 3
    data = torch.rand(1, input_channels, 256, 128).to(device)
